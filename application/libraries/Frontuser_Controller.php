...
class Frontuser_Controller extends MY_Controller 
{
	public function __construct(){
        ...
        $this->data['website_logo_url'] = 'assets/img/pt-logo.svg';
 ...
 /* edit link */
    ...
    {        
        ...
        else
        {
            ...
            if($this->session->userdata('type') == 'USER' || $this->session->userdata('type') == 'ADMIN' || $this->session->userdata('type') == 'AGENT' || $this->session->userdata('type') == 'ADMINISTRATOR BASHKIE' || $this->session->userdata('type') == 'PUNONJES BASHKIE')
            {
                // LOGIN USER, OK
            }
            else
