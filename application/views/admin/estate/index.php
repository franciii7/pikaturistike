        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="dropdown pull-right hidden-emptydropdown">
                    <button class="btn btn-success dropdown-toggle" type="button" id="dropdownImport"
            ...
            <div class="col-md-12">
                <div class="widget wlightblue">
                    ...
                    <div class="widget-content">
                        <form class="search-admin form-inline"
                              action="<?php echo site_url($this->uri->uri_string()); ?>" method="GET"
                              autocomplete="off">
                            <div class="form-group">
                                <input class="form-control" name="smart_search" id="smart_search"
                                       value="<?php echo set_value_GET('smart_search', '', true); ?>"
                                       placeholder="<?php echo lang_check('Smart item search'); ?>" type="text"/>
                            </div>
                            <div class="form-group">
                            ...
                            <?php if ($this->session->userdata('type') == 'ADMIN'): ?>
                                <div class="form-group">
                                    <input class="form-control" name="name_surname" id="name_surname"
                                           value="<?php echo set_value_GET('name_surname', '', true); ?>"
                                           placeholder="<?php echo lang_check('Agent name'); ?>" type="text"/>
                                </div>
                            <?php else: ?>
                                <div class="form-group">
                                    <input class="form-control" name="name_of_user" id="name_of_user"
                                           value="<?php echo set_value_GET('name_of_user', '', true); ?>"
                                           placeholder="<?php echo lang_check('Agent name'); ?>" type="text"/>
                                </div>
                            <?php endif; ?>
                            <button type="submit" class="btn btn-default"><i
                                        class="icon icon-search"></i>&nbsp;&nbsp;<?php echo lang_check('Search'); ?>
                            </button>
                        ...
                        <table class="table table-bordered footable">
                            ...
                            <tr>
                                <th style='white-space:nowrap'>
                                    # <?php echo field_order_by($field_title = 'property.id'); ?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tooltip_preview">
                                            <?php if (!empty($estate->image_filename) && file_exists(FCPATH . 'files/thumbnail/' . $estate->image_filename)): ?>
                                                <a class="tooltipbox" target="_blank"
                                                   href="<?php echo site_url((config_item('listing_uri') === false ? 'property' : config_item('listing_uri')) . '/' . $estate->id); ?>">
                                                    <img src="<?php echo _simg('files/thumbnail/' . $estate->image_filename, '56x40'); ?>"
                                                         width="56px" height="40px" alt=""/>
                                                </a>
                                            <?php endif; ?>
                                            <?php echo anchor('admin/estate/edit/' . $estate->id, _ch($estate->address)) ?>
                                            <?php if ($estate->is_activated == 0): ?>
                                                &nbsp;&nbsp;&nbsp;&nbsp;<span
                                                        class="label label-danger"><?php echo lang_check('Not Activated') ?></span>
                                            <?php endif; ?>
                                            <?php if (isset($settings['listing_expiry_days']) && $settings['listing_expiry_days'] > 0 && strtotime($estate->date_modified) <= time() - $settings['listing_expiry_days'] * 86400): ?>
                                                &nbsp;&nbsp;&nbsp;&nbsp;<span
                                                        class="label label-warning"><?php echo lang_check('Expired'); ?></span>
                                            <?php endif; ?>
                                            <?php if (!empty($estate->activation_paid_date)): ?>
                                                &nbsp;&nbsp;&nbsp;&nbsp;<span
                                                        class="label label-success"><?php echo lang_check('Paid'); ?></span>
                                            <?php endif; ?>
                                            <?php if (!empty($estate->status)): ?>
                                                &nbsp;&nbsp;&nbsp;&nbsp;<span
                                                        class="label label-info"><?php echo $estate->status; ?></span>
                                            <?php endif; ?>
                                        </td>

                                        <td><?php if ($this->session->userdata('type') == 'ADMINISTRATOR BASHKIE' || $this->session->userdata('type') == 'PUNONJES BASHKIE'):
                                        ...
                                        <td>
                                            <?php echo $estate->municipality_id == null ? "-" : $municipalities[$estate->municipality_id] ?>
                                        </td>
                                        ...
                                        <td style="white-space: nowrap; ">
                                            <a class="btn btn-info"  target="_blank"
                                               href="<?php echo site_url((config_item('listing_uri') === false ? 'property' : config_item('listing_uri')) . '/' . $estate->id . '?preview=true'); ?>"><i
                                                        class="icon-search"></i></a>
                                            <?php if (config_item('thumbs_admin_enabled')): ?>
                                            <?php if (!empty($estate->image_filename) && file_exists(FCPATH . 'files/thumbnail/' . $estate->image_filename)): ?>
                                            <a class="preview" target="_blank"
                                               href="<?php echo site_url((config_item('listing_uri') === false ? 'property' : config_item('listing_uri')) . '/' . $estate->id); ?>">
                                                <img src="<?php echo _simg('files/thumbnail/' . $estate->image_filename, '32x32'); ?>"
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <?php if ($estate->status == 'RESUBMIT'): ?>
                                                                <a href="<?php echo site_url('admin/estate/status/' . $estate->id . '/APPROVE_RESUBMIT'); ?>">
                                                                    <i class="icon-ok"></i> <?php echo lang_check('Approve'); ?>
                                                                </a>
                                                            <?php else: ?>
                                                        ...
                                                        <li>
                                                            <?php if ($estate->status == 'REDUCED_PRICE'): ?>
                                                                <a class=""
                                                                   href="<?php echo site_url('admin/estate/status/' . $estate->id . '/HOLD_REDUCED/statuses'); ?>">
                                                                    <i class="icon-pause"></i> <?php echo lang_check('On hold'); ?>
                                                                </a>
                                                            <?php elseif ($estate->status == 'RESUBMIT'): ?>
                                                                <a class=""
                                                                   href="<?php echo site_url('admin/estate/status/' . $estate->id . '/HOLD_RESUBMIT/statuses'); ?>">
                                                                    <i class="icon-pause"></i> <?php echo lang_check('On hold'); ?>
                                                                </a>
                                                            <?php else: ?>
                                                                <a class=""
                                                                   href="<?php echo site_url('admin/estate/status/' . $estate->id . '/HOLD/statuses'); ?>">
                                                                    <i class="icon-pause"></i> <?php echo lang_check('On hold'); ?>
                                                                </a>
                                                            <?php endif; ?>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a href="<?php echo site_url('admin/estate/status/' . $estate->id . '/DECLINE'); ?>">
                                                                <i class="icon-remove-sign"></i> <?php echo lang_check('Decline'); ?>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <?php if ($estate->status == 'HOLD_REDUCED'): ?>
                                                                    <a class=""
                                                                       href="<?php echo site_url('admin/estate/status/' . $estate->id . '/APPROVE_REDUCED/statuses'); ?>">
                                                                        <i class="icon-ok"></i> <?php echo lang_check('Approve'); ?>
                                                                    </a>
                                                                <?php else: ?>
                                                                    <a class=""
                                                                       href="<?php echo site_url('admin/estate/status/' . $estate->id . '/APPROVE/statuses'); ?>">
                                                                        <i class="icon-ok"></i> <?php echo lang_check('Approve'); ?>
                                                                    </a>
                                                                <?php endif; ?>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo site_url('admin/estate/status/' . $estate->id . '/CONTRACT'); ?>">
                                                                    <i class="icon-briefcase"></i> <?php echo lang_check('Contract property'); ?>
                                                                </a>
                                                            </li>
                                                        </ul>
                                        ...
                                        <?php elseif (check_acl('estate/delete')): ?>
                                            <td>
                                                ...
                                                <button class="btn btn-danger" data-toggle="modal"
                                                        data-locId="<?php echo $estate->id ?>" data-target="#delete">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget worange">
                        <div class="widget-head">
                            <div class="pull-left"><?php echo lang_check('Frequently asked questions') ?>
                            </div>
                            <div class="widget-icons pull-right">
                                <a class="wminimize" href="#"><i class="icon-chevron-up"></i></a>
                            </div>
                        ...
                        <div class="widget-content" style="padding: 10px;">
                            <div class="list-group">
                                <a href="http://iwinter.com.hr/support/?p=162" target="_blank"
                                   class="list-group-item"><?php echo lang_check('How to add / edit or delete the menu tabs on map ? i.e Sale , Rent and both ?') ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('document').ready(function () {
        ...
        $('#delete').on('show.bs.modal', function (event) {
            ...
            var loc_Id = button.data('locid');
            var modal = $(this);
            modal.find('#loc_Id').val(loc_Id);
            var $modalForm = modal.find('form');
            var formAction = $modalForm.attr('action');
            $modalForm.attr('action', formAction + loc_Id);
        });
    })
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="http://localhost/pikaturistike/index.php/admin/estate/delete/"
                  method="post">

                <input type="hidden" name="location_Id" id="loc_Id" value=""/>
