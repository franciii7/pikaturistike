                            ...
                            <table class="table table-bordered footable">
                                <thead>
                                    <tr>
                                        ...
                                        <button type="submit" onclick="return confirm('<?php _l('Are you sure?'); ?>');" class="btn btn-xs btn-warning" style="border-radius:50%;"><i class="icon-remove"></i></button>
                                        </th>
                                        <?php endif;?>
                                    </tr>
                                </thead>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap; ">
                                                <a class="btn btn-info" style="border-radius:50%;"target="_blank" href="<?php echo site_url((config_item('listing_uri')===false?'property':config_item('listing_uri')).'/'.$estate->id.'?preview=true');?>"><i class="icon-search"></i></a>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="http://localhost/pikaturistike/index.php/admin/estate/delete/<?php echo $estate->id?>" method="post">
